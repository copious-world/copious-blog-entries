...
// -- -- -- --
//
class ODBPersistenceEndpoint extends PersistenceCategory {
...
console.log(`ODB Server: PORT: ${endpoint.port} ADDRESS: ${endpoint.address}`)

new ODBPersistenceEndpoint(endpoint)
